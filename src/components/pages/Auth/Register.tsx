                ...
                <Card variant="borderless" style={{ padding: 16 }}>
                    <Row gutter={[48, 32]} align="middle">
                        <Col span={12}>
                            ...
                            <Image src="/signup.svg" alt="signup" preview={false} width="100%" />
                        </Col>
                            ...
                            <Space orientation="vertical" size="middle" style={{ width: '100%' }}>
                                ...
                                {createUserApi.isSuccess && (
                                    <Alert
                                        ...
                                        description={
                                            <Text>
                                                Please Login with your credentials <Link href="/">here</Link>
                                            </Text>
                                        }
                                        type="success"
                                        showIcon
                                ...
                                <Form<FormFields> layout="vertical" size="large" onFinish={onFinish} requiredMark="optional">
                                    <Form.Item
                                        label="Username"
                                        name="username"
                                        required
                                    ...
                                    <Form.Item label="Nickname" name="altName" rules={[{ min: 1, message: 'Minimum 1 characters' }]}>
